...
import { _ as _sfc_main$1 } from './registration-k5nvoTia.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "Daftar Sebagai Pelanggan atau Mitra | PT Marier Jaya Abadi",
      meta: [
        {
          name: "description",
...
//# sourceMappingURL=index-UKSjUllc.mjs.map
